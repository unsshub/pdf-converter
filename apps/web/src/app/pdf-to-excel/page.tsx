        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          {showUpload && (
            <div className="text-center mb-8 pt-4">
              ...
              <h1 className="text-3xl font-bold text-slate-800 dark:text-white mb-2">PDF to Excel</h1>
              <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto text-sm">Pull data straight from PDFs into Excel spreadsheets. The converted XLSX file preserves table data with incredible accuracy.</p>
            </div>
          )}
